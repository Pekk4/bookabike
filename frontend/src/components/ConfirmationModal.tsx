  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center">
        <div className={modalClass}>
            ...
            <button onClick={() => yesHandler()} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 mx-4">Yes</button>
            <button onClick={() => noHandler()} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 mx-4">No</button>
            </div>
        </div>
    </div>
  );
