...
describe("Modal component", () => {
  ...
  test("applies red styles when isError is true", () => {
    render(<Modal message="Error Message" isError={true} yesHandler={() => {}} noHandler={() => {}} />);
  ...
  test("renders the modal with the correct structure", () => {
    ...
    expect(modalElement.parentElement).toHaveClass("fixed inset-0 bg-black/60 z-50 flex items-center justify-center");
  });
