...
const HomeDemo: React.FC = () => {
  return (
    <div className="flex relative h-screen w-screen items-center justify-center text-center bg-[url('/bike4.png')] bg-cover bg-no-repeat ">
      <div className="absolute inset-28 bg-orange-50 opacity-90 rounded-md flex flex-row">
        {/* Vasen */}
        <div className="m-20">
          {/* Uutiset */}
        ...
        <div className="m-20">
          <p className="p-10">
            MotOrgBike on yhdistyksemme oma moottoripyörä, joka on tarkoitettu jäsenten
            lainattavaksi 1-4 päiväksi kerrallaan. Pyörä on Yamaha MT-07, vuosimallia 2017, ja sen
            teho on 55 kW, joten kuljettamiseen vaadittava ajokorttiluokka on A. Lainaaminen
            edellyttää voimassaolevaa yhdistyksen jäsenyyttä. Siirry{' '}
